...
<body>
    ...
    <script src="<?php echo e(asset('js/utils/tooltip.js')); ?>"></script>
    <script src="<?php echo e(asset('js/utils/toast.js')); ?>"></script>
    <script src="<?php echo e(asset('js/utils/confirmDialog.js')); ?>"></script>
